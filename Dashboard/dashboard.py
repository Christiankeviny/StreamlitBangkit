...
with tab3:
    ...
    st.write("Alasan mengapa kedua kota mendapatkan nilai minimum di bulan yang sama, sebenarnya bisa di explore lagi dengan mengamati rata-rata nilai curah hujan tiap bulannya dari tahun ke tahun")